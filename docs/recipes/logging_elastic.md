...
> :bulb: If you want an existing sample to run, the [sample here](https://github.com/drakon660/tye2/tree/main/samples/frontend-backend) will do. This recipe will show examples of UI and data based on that sample. You own application will work fine, but the data and examples will look different.
...
First, perform some operation that will trigger a cross-service call so we have some data to use. If you're using the [sample here](https://github.com/drakon660/tye2/tree/main/samples/frontend-backend) then visiting the frontend application in the browser will do.
