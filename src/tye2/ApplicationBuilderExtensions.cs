...
namespace Tye2
{
    public static class ApplicationBuilderExtensions
    {
        ...
        public static Tye2.Hosting.Model.EnvironmentVariable ToHostingEnvironmentVariable(this EnvironmentVariableBuilder builder)
        {
            var env = new Tye2.Hosting.Model.EnvironmentVariable(builder.Name);
            env.Value = builder.Value;
            if (builder.Source != null)
            {
                env.Source = new Tye2.Hosting.Model.EnvironmentVariableSource(builder.Source.Service, builder.Source.Binding);
                env.Source.Kind = (Tye2.Hosting.Model.EnvironmentVariableSource.SourceKind)(int)builder.Source.Kind;
            }
