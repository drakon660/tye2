...
- `Redis` can be deployed using the below command :
    ...
    ```
    kubectl apply -f https://raw.githubusercontent.com/drakon660/tye2/main/docs/tutorials/redis.yaml
    ```
- `Postgresql` can be installed by the following command :

    ```
    kubectl apply -f https://raw.githubusercontent.com/drakon660/tye2/main/docs/tutorials/postgres.yaml
    ```
