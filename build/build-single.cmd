...
set "OUTPUT=%REPO_ROOT%\artifacts\single\%RID%"
...
dotnet publish "%PROJECT%" -c Release -r %RID% --self-contained true -o "%OUTPUT%" --nologo ^
...
popd
echo Single-file build completed. Output: %OUTPUT%
exit /b 0
